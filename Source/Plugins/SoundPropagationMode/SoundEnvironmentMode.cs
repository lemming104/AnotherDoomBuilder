...
namespace CodeImp.DoomBuilder.SoundPropagationMode
{
    ...
    public class SoundEnvironmentMode : ClassicMode
    {
        ...
        internal static SoundEnvironmentPanel SoundEnvironmentPanel { get; private set; } //mxd
        ...
        private void Highlight(Sector s)
        {
            ...
            SoundEnvironmentPanel.HighlightSoundEnvironment(highlightedsoundenvironment);
        }
        ...
        private void UpdateData()
        {
            ...
            SoundEnvironmentPanel.SoundEnvironments.Nodes.Clear();
            ...
            {
                SoundEnvironmentPanel.BeginUpdate(); //mxd

                foreach (SoundEnvironment se in BuilderPlug.Me.SoundEnvironments)
                    SoundEnvironmentPanel.AddSoundEnvironment(se);

                SoundEnvironmentPanel.EndUpdate(); //mxd
            }
        }
        ...
        public override void OnEngage()
        {
            ...
            SoundEnvironmentPanel = new SoundEnvironmentPanel();
            SoundEnvironmentPanel.OnShowWarningsOnlyChanged += PanelOnOnShowWarningsOnlyChanged;
            docker = new Docker("soundenvironments", "Sound Environments", SoundEnvironmentPanel);
        ...
        protected override void OnSelectEnd()
        {
            ...
            {
                SoundEnvironmentPanel.SelectSoundEnvironment(highlightedsoundenvironment);
            }
        }
        ...
        private void worker_RunWorkerCompleted(object sender, RunWorkerCompletedEventArgs e)
        {
            ...
            SoundEnvironmentPanel.HighlightSoundEnvironment(highlightedsoundenvironment); //mxd. Expand highlighted node in the treeview
        ...
        public override void OnDisengage()
        {
            ...
            SoundEnvironmentPanel.Dispose(); //mxd
            SoundEnvironmentPanel = null; //mxd
