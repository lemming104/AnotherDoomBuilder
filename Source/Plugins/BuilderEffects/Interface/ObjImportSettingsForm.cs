...
namespace CodeImp.DoomBuilder.BuilderEffects
{
    public partial class ObjImportSettingsForm : DelayedForm
    {
        ...
        internal ImportObjAsTerrainMode.UpAxis UpAxis { get; private set; }
        ...
        public ObjImportSettingsForm()
        {
            ...
            //restore settings
            UpAxis = (ImportObjAsTerrainMode.UpAxis)General.Settings.ReadPluginSetting("objexportupaxis", 0);
        ...
        private void import_Click(object sender, EventArgs e)
        {
            ...
            UpAxis = axisy.Checked ? ImportObjAsTerrainMode.UpAxis.Y : (axisz.Checked ? ImportObjAsTerrainMode.UpAxis.Z : ImportObjAsTerrainMode.UpAxis.X);

            //save settings
            General.Settings.WritePluginSetting("objexportupaxis", (int)UpAxis);
