...
namespace CodeImp.DoomBuilder.UDBScript
{
    ...
    public class BuilderPlug : Plug
    {
        ...
        public string CurrentScriptFile { get; set; }
        internal ScriptInfo CurrentScript { get; set; }
        internal ScriptRunner ScriptRunner { get; private set; }
        internal ScriptDirectoryStructure ScriptDirectoryStructure { get; private set; }
        internal string EditorExePath { get; private set; }
        public ScriptRunnerForm ScriptRunnerForm { get; private set; }
