...
namespace CodeImp.DoomBuilder.BuilderModes
{
    ...
    public class EditSelectionMode : BaseClassicMode
    {
        ...
        public bool UpdateSlopes { get; set; }

        //mxd. Modification
        internal bool UsePrecisePosition { get; set; }
        ...
        internal HeightAdjustMode SectorHeightAdjustMode { get; set; }
        ...
        public override void OnEngage()
        {
            ...
            SectorHeightAdjustMode = (HeightAdjustMode)General.Settings.ReadPluginSetting("editselectionmode.heightadjustmode", (int)HeightAdjustMode.NONE);
            ...
            if ((selectedvertices.Count > 0) || (selectedthings.Count > 0))
            {
                ...
                panel.SetHeightAdjustMode(SectorHeightAdjustMode, sectors.Count > 0); //mxd
                UpdateRectangleComponents();
                UpdatePanel();
                Update();
        ...
        public override void OnAccept()
        {
            ...
            if ((selectedthings.Count > 0) || (selectedvertices.Count > 0))
            {
                ...
                else
                {
                    ...
                    if (unstablelines.Count == 0 && SectorHeightAdjustMode != HeightAdjustMode.NONE)
                    {
                ...
                if (changedlines.Count > 0 && SectorHeightAdjustMode != HeightAdjustMode.NONE
                    && oldoutsidefloorheight != int.MinValue && oldoutsideceilingheight != int.MinValue)
                {
                    ...
                    AdjustSectorsHeight(draggedsectors, SectorHeightAdjustMode, oldoutsidefloorheight, oldoutsideceilingheight);
                }
        ...
        public override void OnDisengage()
        {
            ...
            General.Settings.WritePluginSetting("editselectionmode.heightadjustmode", (int)SectorHeightAdjustMode);
