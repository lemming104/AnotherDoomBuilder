...
namespace CodeImp.DoomBuilder.BuilderModes.FindReplace
{
    ...
    internal class FindSectorUDMFField : BaseFindUDMFField
    {
        ...
        public override FindReplaceObject[] Find(string value, bool withinselection, bool replace, string replacewith, bool keepselection)
        {
            ...
            ICollection<MapElement> list = withinselection ? new List<MapElement>(DoomBuilder.General.Map.Map.GetSelectedSectors(true)) : (ICollection<MapElement>)DoomBuilder.General.Map.Map.Sectors;
