...
namespace CodeImp.DoomBuilder.BuilderModes
{
    internal class BaseVisualSector : VisualSector
    {
        ...
        public VisualCeiling Ceiling { get; private set; }
        public List<VisualFloor> ExtraFloors { get; private set; }
        public List<VisualCeiling> ExtraCeilings { get; private set; }
        public List<VisualFloor> ExtraBackFloors { get; } //mxd
        public List<VisualCeiling> ExtraBackCeilings { get; } //mxd
        public Dictionary<Sidedef, VisualSidedefParts> Sides { get; private set; } //mxd
