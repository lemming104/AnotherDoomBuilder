...
namespace CodeImp.DoomBuilder.BuilderModes
{
    ...
    {
        public bool DOOM { get; set; } = true;
        public bool HEXEN { get; set; } = true;
        public bool UDMF { get; set; } = true;
        public string Description { get; set; } = "Unnamed field";
        ...
        public bool SupportsCurrentMapFormat
        {
            get
            {
                ...
                if (!string.IsNullOrEmpty(Field1) || !string.IsNullOrEmpty(Field2)) return General.Map.UDMF;
