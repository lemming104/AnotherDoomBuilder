...
namespace CodeImp.DoomBuilder.ThreeDFloorMode
{
    ...
    public class BuilderPlug : Plug
    {
        ...
        public ControlSectorArea ControlSectorArea { get; private set; }
        public float HighlightSlopeRange { get; private set; }
        public List<SlopeVertexGroup> SlopeVertexGroups { get; set; }
        public float StitchRange { get; private set; }
        public bool SelectChangedAfterUndoRedo { get; internal set; }

        public Sector SlopeDataSector { get; set; }

        public LabelDisplayOption SectorLabelDisplayOption { get; set; }
        public LabelDisplayOption SlopeVertexLabelDisplayOption { get; set; }
        ...
        public static ThreeDFloorEditorWindow TDFEW { get; private set; } = new ThreeDFloorEditorWindow();
