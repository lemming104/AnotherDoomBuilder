...
namespace CodeImp.DoomBuilder.ThreeDFloorMode
{
    ...
    public class ControlSectorArea
    {
        ...
        public bool UseCustomTagRnage { get; set; }
        ...
        public void SaveConfig()
        {
            ...
            config.Add("usecustomtagrange", UseCustomTagRnage);

            if (UseCustomTagRnage)
            {
        ...
        public void LoadConfig()
        {
            ...
            UseCustomTagRnage = General.Map.Options.ReadPluginSetting("controlsectorarea.usecustomtagrange", false);
