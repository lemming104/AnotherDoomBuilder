...
namespace CodeImp.DoomBuilder.StairSectorBuilderMode
{
    public partial class StairSectorBuilderForm : DelayedForm
    {
        ...
        public int OriginalFloorBase { set; get; }

        public int OriginalCeilingBase { set; get; }
        ...
        public CheckBox DistinctBaseHeights { get; set; }

        public CheckBox SingleSteps { get; set; }

        public CheckBox DistinctSectors { get; set; }

        public CheckBox SingleDirection { get; set; }
        ...
        public StairSectorBuilderForm()
        {
            ...
            foreach (BuilderPlug.Prefab p in BuilderPlug.Me.Prefabs)
            {
                ...
                lvi.Text = p.name;
                lvisi.Text = Tabs.TabPages[p.stairtype].Text;
        ...
        private void SavePrefab(string name, bool forceoverwrite, int position)
        {
            ...
            lvi.Text = name;
            lvisi.Text = Tabs.TabPages[Tabs.SelectedIndex].Text;
            ...
            pf.stairtype = Tabs.SelectedIndex;
        ...
        private void LoadPrefab(BuilderPlug.Prefab p)
        {
            ...
            Tabs.SelectedIndex = p.stairtype;
