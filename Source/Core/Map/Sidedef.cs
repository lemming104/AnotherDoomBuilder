...
namespace CodeImp.DoomBuilder.Map
{
    public sealed class Sidedef : MapElement
    {
        ...
        public double Angle { get { return IsFront ? Line.Angle : Angle2D.Normalized(Line.Angle + Angle2D.PI); } }
        ...
        public override void Dispose()
        {
            ...
            if (!isdisposed)
            {
                ...
                // Detach from linedef
                if (Line != null) Line.DetachSidedefP(this);
        ...
        public void RemoveUnneededTextures(bool removemiddle, bool force, bool shiftmiddle)
        {
            ...
            if (force || ((Line.Tag == 0) && (Line.Action == 0) && (Sector.Tag == 0) &&
        ...
        {
#if DEBUG
            return "Sidedef " + listindex + (marked ? " (marked)" : "") + " (Line " + Line.Index + (Line.Marked ? " (marked)" : "") + ", Sector " + Sector.Index + (Sector.Marked ? " (marked)" : "") + ")";
#else
