...
namespace CodeImp.DoomBuilder.Rendering
{
    internal sealed class Renderer3D : Renderer, IRenderer3D
    {
        ...
        public ProjectedFrustum2D Frustum2D { get; private set; }
        public bool DrawThingCages { get; set; }
        ...
        internal Renderer3D(RenderDevice graphics) : base(graphics)
        {
            ...
            // Dummy frustum
            Frustum2D = new ProjectedFrustum2D(new Vector2D(), 0.0f, 0.0f, PROJ_NEAR_PLANE,
        ...
        public void PositionAndLookAt(Vector3D pos, Vector3D lookat)
        {
            ...
            // Create frustum
            Frustum2D = new ProjectedFrustum2D(pos, (float)anglexy, (float)anglez, PROJ_NEAR_PLANE,
                General.Settings.ViewDistance, (float)Angle2D.DegToRad(General.Settings.VisualFOV));
