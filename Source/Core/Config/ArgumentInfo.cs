...
namespace CodeImp.DoomBuilder.Config
{
    public class ArgumentInfo
    {
        ...
        public string ToolTip { get; } //mxd
        public bool Used { get; }
        public int Type { get; }
        public HashSet<string> TargetClasses { get; } //mxd
        public EnumList Enum { get; internal set; }
        public EnumList Flags { get; internal set; } //mxd
        public object DefaultValue { get; } //mxd
        public ArgumentRenderStyle RenderStyle { get; } //mxd
        ...
        public bool Str { get; } // [ZZ]
        public string TitleStr { get; } // [ZZ]
        ...
        internal ArgumentInfo(Configuration cfg, string argspath, int argindex, IDictionary<string, EnumList> enums)
        {
            ...
            if (argdic.Contains("enum"))
            {
                ...
                if (argdic["enum"] is IDictionary)
                {
                    ...
                    this.Enum = new EnumList((IDictionary)argdic["enum"]);
                }
                else
                {
                    ...
                    {
                        // Get the enum list
                        this.Enum = enums[argdic["enum"].ToString()];
                    }
                    else
                    {
            ...
            if (argdic.Contains("flags"))
            {
                ...
                {
                    // Create anonymous enum
                    this.Flags = new EnumList((IDictionary)argdic["flags"]);
                }
                else
                {
                    // Check if referenced enum exists
                    ...
                    {
                        // Get the enum list
                        this.Flags = enums[argdic["flags"].ToString()];
                    }
                    else
                    {
            ...
            if (this.Enum == null) this.Enum = new EnumList(); //mxd
            if (this.Flags == null) this.Flags = new EnumList(); //mxd
        }
        ...
        internal ArgumentInfo(ActorStructure actor, int i)
        {
            ...
            if (!string.IsNullOrEmpty(enumstr))
            {
                ...
                {
                    this.Enum = enums[enumstr.ToLowerInvariant()];
                }
                else
                {
            ...
            if (this.Enum == null) this.Enum = new EnumList();
        }
