...
namespace CodeImp.DoomBuilder.Config
{
    ...
    public class ThingFlagsCompare
    {
        ...
        public HashSet<string> RequiredGroups { get; } //mxd
        public HashSet<string> IgnoredGroups { get; } //mxd
        public string RequiredFlag { get; internal set; } //mxd
        public bool IgnoreGroupWhenUnset { get; } //mxd
        ...
        public ThingFlagsCompare(Configuration cfg, string group, string flag)
        {
            ...
            IgnoreGroupWhenUnset = cfg.ReadSetting(cfgpath + ".ingnorethisgroupwhenunset", false); //mxd
        ...
        public bool Compare(Thing t1, Thing t2)
        {
            ...
            if (!t1flag && !t2flag && IgnoreGroupWhenUnset) return false;
