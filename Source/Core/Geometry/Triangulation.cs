...
namespace CodeImp.DoomBuilder.Geometry
{
    ...
    public sealed class Triangulation
    {
        ...
        public ReadOnlyCollection<int> IslandVertices { get; private set; }
        public ReadOnlyCollection<Vector2D> Vertices { get; private set; }
        public ReadOnlyCollection<Sidedef> Sidedefs { get; private set; }
