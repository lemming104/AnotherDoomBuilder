    ...
    internal partial class GridSetupForm : DelayedForm
    {
        ...
        public GridSetupForm()
        {
               ...
               !(General.Map.Grid.Background is UnknownImage))
            {
                ...
                backgroundimage.Image = General.Map.Grid.Background.GetBackgroundBitmap();
            }
            else
            {
                // No background image
        ...
        private void selecttexture_Click(object sender, EventArgs e)
        {
            ...
            if (result != null)
            {
                ...
                backgroundimage.Image = img.GetBackgroundBitmap();
            }
        }
        ...
        private void selectfile_Click(object sender, EventArgs e)
        {
            ...
            if (browsefile.ShowDialog(this) == DialogResult.OK)
            {
                ...
                backgroundimage.Image = new Bitmap(img.GetBackgroundBitmap());
                img.Dispose();
            }
        }
