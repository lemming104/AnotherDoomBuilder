...
namespace CodeImp.DoomBuilder.Windows
{
    public partial class MainForm : DelayedForm, IMainForm
    {
        ...
        new public MouseButtons MouseButtons { get; private set; }
        public bool MouseInDisplay { get; private set; }
        public RenderTargetControl Display { get; private set; }
        public bool SnapToGrid { get { return buttonsnaptogrid.Checked; } }
        public bool AutoMerge { get { return buttonautomerge.Checked; } }
        public bool MouseExclusive { get; private set; }
        new public IntPtr Handle { get; }
        ...
        {
            if (MouseExclusive && IsActiveWindow && MouseInDisplay && Cursor.Clip != Display.RectangleToScreen(Display.ClientRectangle))
        ...
        private void display_MouseDown(object sender, MouseEventArgs e)
        {
            ...
            int mod = 0;
            if (AltState) mod |= (int)Keys.Alt;
            if (ShiftState) mod |= (int)Keys.Shift;
            if (CtrlState) mod |= (int)Keys.Control;
