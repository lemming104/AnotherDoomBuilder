...
namespace CodeImp.DoomBuilder.ZDoom
{
    internal sealed class GldefsParser : ZDTextParser
    {
        ...
        internal Dictionary<string, DynamicLightData> LightsByName { get; }
        internal Dictionary<string, string> Objects { get; }
        internal Dictionary<long, GlowingFlatData> GlowingFlats { get; }
        internal Dictionary<string, SkyboxInfo> Skyboxes { get; }
