...
namespace CodeImp.DoomBuilder.ZDoom.Scripting
{
    internal sealed class AcsParserSE : ZDTextParser
    {
        ...
        internal List<ScriptItem> NamedScripts { get; }
        internal List<ScriptItem> NumberedScripts { get; }
        internal List<ScriptItem> Functions { get; }
        internal bool IsLibrary { get { return !string.IsNullOrEmpty(LibraryName); } }
        internal string LibraryName { get; private set; }
