...
namespace CodeImp.DoomBuilder.ZDoom
{
    public sealed class DecorateParser : ZDTextParser
    {
                        ...
                        case "actor":
                            {
                                ...
                                // Add the actor
                                AllActorsByClass[actor.ClassName.ToLowerInvariant()] = actor;
                                if (actor.CheckActorSupported())
                                    ActorsByClass[actor.ClassName.ToLowerInvariant()] = actor;

                                // Replace an actor?
                                if (actor.ReplacesClass != null)
                                {
                                    if (GetArchivedActorByName(actor.ReplacesClass) != null)
                                        AllActorsByClass[actor.ReplacesClass.ToLowerInvariant()] = actor;
                                    else
                                    ...
                                    if (actor.CheckActorSupported() && GetActorByName(actor.ReplacesClass) != null)
                                        ActorsByClass[actor.ReplacesClass.ToLowerInvariant()] = actor;
                                }
        ...
        internal ActorStructure GetArchivedActorByName(string name)
        {
            ...
            return AllActorsByClass.ContainsKey(name) ? AllActorsByClass[name] : null;
        }
