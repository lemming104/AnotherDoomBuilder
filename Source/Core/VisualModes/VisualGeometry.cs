...
namespace CodeImp.DoomBuilder.VisualModes
{
    public abstract class VisualGeometry : IVisualPickable
    {
        ...
        // Internal properties
        public WorldVertex[] Vertices { get; private set; } //mxd
        internal int VertexOffset { get; set; }
        ...
        /// </summary>
        public RenderPass RenderPass { get; set; } = RenderPass.Solid;
        ...
        /// </summary>
        public VisualSector Sector { get; internal set; }
