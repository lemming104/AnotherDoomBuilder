...
namespace CodeImp.DoomBuilder.Data
{
    public sealed class DataManager
    {
        ...
        //mxd
        internal Dictionary<int, ModelData> ModeldefEntries { get; private set; }
        internal Dictionary<int, DynamicLightData> GldefsEntries { get; private set; }
        public MapInfo MapInfo { get; private set; }
        public Dictionary<string, KeyValuePair<int, int>> Reverbs { get; private set; }
        public Dictionary<long, GlowingFlatData> GlowingFlats { get; private set; }
        public string[] SoundSequences { get; private set; }
        public string[] TerrainNames { get; private set; }
        public string[] DamageTypes { get; private set; }
        public Dictionary<string, PixelColor> KnownColors { get; private set; }
        internal Dictionary<ScriptType, HashSet<ScriptResource>> ScriptResources { get; private set; }
        internal CvarsCollection CVars { get; private set; }
        public Dictionary<int, PixelColor> LockColors { get; private set; }
        public Dictionary<int, int> LockableActions { get; private set; }
        public Dictionary<int, AmbientSoundInfo> AmbientSounds { get; private set; }

        //mxd
        internal IEnumerable<DataReader> Containers { get { return containers; } }

        public Playpal Palette { get; private set; }
        public ColorMap MainColorMap { get; private set; }
        public ICollection<ImageData> Textures { get { return textures.Values; } }
        public ICollection<ImageData> Flats { get { return flats.Values; } }
        public List<string> TextureNames { get; private set; }
        public List<string> FlatNames { get; private set; }
        public bool IsDisposed { get; private set; }
        public ImageData MissingTexture3D { get; private set; }
        public ImageData UnknownTexture3D { get; private set; }
        public ImageData UnknownImage { get { return unknownimage; } }
        public ImageData Hourglass3D { get; private set; }
        public ImageData Crosshair3D { get; private set; }
        public ImageData CrosshairBusy3D { get; private set; }
        public Texture LoadingTexture { get; private set; }
        public Texture FailedTexture { get; private set; }
        public ImageData WhiteTexture { get; private set; }
        public ImageData BlackTexture { get; private set; } //mxd
        public ImageData ThingTexture { get; private set; } //mxd
        internal ImageData FolderTexture { get; private set; } //mxd
        internal ImageData FolderUpTexture { get; private set; } //mxd
        public ImageData[] CommentTextures { get; private set; } //mxd
        internal CubeTexture SkyBox { get; private set; } //mxd
        public List<ThingCategory> ThingCategories { get; private set; }
        public ICollection<ThingTypeInfo> ThingTypes { get { return thingtypes.Values; } }
        public DecorateParser Decorate { get; private set; }
        public ZScriptParser ZScript { get; private set; }
        ...
        internal AllTextureSet AllTextureSet { get; private set; }
        internal AllTextureSet WallTextureSet { get; private set; }
        internal AllTextureSet FlatTextureSet { get; private set; }
        ...
        internal void Dispose()
        {
            ...
            if (!IsDisposed)
            {
                ...
                Crosshair3D.Dispose();
                Crosshair3D = null;
                CrosshairBusy3D.Dispose();
                CrosshairBusy3D = null;
        ...
        internal void Load(DataLocationList configlist, DataLocationList maplist)
        {
            ...
            AllTextureSet = new AllTextureSet();
            ...
            foreach (KeyValuePair<long, ImageData> img in textures)
            {
                ...
                // Add to all
                AllTextureSet.AddTexture(img.Value);
            ...
            foreach (KeyValuePair<long, ImageData> img in flats)
            {
                ...
                // Add to all
                AllTextureSet.AddFlat(img.Value);
        ...
        private void LoadInternalTextures()
        {
            ...
            Crosshair3D = LoadInternalTexture("Crosshair.png");
            CrosshairBusy3D = LoadInternalTexture("CrosshairBusy.png");
