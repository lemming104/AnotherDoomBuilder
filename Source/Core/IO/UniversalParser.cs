...
namespace CodeImp.DoomBuilder.IO
{
    public sealed class UniversalParser
    {
        ...
        // Properties
        public int ErrorResult { get; private set; }
        public string ErrorDescription { get; private set; } = "";
        public int ErrorLine { get; private set; }
        public UniversalCollection Root { get; private set; }
        public bool StrictChecking { get; set; } = true;
        ...
        private UniversalCollection InputStructure(ref string[] data, ref int pos, ref int line, bool topLevel)
        {
            ...
            while ((ErrorResult == 0) && (endofstruct == false))
            {
